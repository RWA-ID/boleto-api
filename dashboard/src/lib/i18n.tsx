...
const translations = {
  en: {
    ...
    home: {
      ...
      description: 'Web3 ticketing infrastructure for Latin American events. Issue ENS subdomain-based NFT tickets on Base with permanent on-chain identity.',
      createEvent: 'Create Event',
      ...
      step02Desc: 'Issue ERC-721 NFT tickets on Base L2 via REST API. Each ticket is soulbound or transferable — your choice.',
      ...
      guarantees: [
        ...
        'Ticket NFTs on Base L2 — cheap minting, fast confirmation',
        'Soulbound or transferable — set per event, toggleable by promoter',
        '1.5% platform royalty on secondary sales — hardcoded, immutable',
  ...
  es: {
    nav: {
      ...
      apiKeys: 'Claves API',
      scanner: 'Escáner de Puerta',
    },
    home: {
      tagline: 'Protocolo de Boletería Web3',
      description: 'Infraestructura de boletería Web3 para eventos latinoamericanos. Emite tickets NFT basados en subdominios ENS en Base con identidad permanente en cadena.',
      createEvent: 'Crear Evento',
      ...
      step02Desc: 'Emite tickets NFT ERC-721 en Base L2 vía REST API. Cada ticket es soulbound o transferible — tú decides.',
      ...
      guarantees: [
        ...
        'Tickets NFT en Base L2 — minteo económico, confirmación rápida',
        'Soulbound o transferible — configurable por evento, el promotor puede cambiarlo',
        '1.5% regalía de plataforma en ventas secundarias — fija e inmutable',
